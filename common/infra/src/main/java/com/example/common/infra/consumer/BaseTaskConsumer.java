package com.example.common.infra.consumer;

import com.example.common.infra.heavytask.HeavyTask;
...
public abstract class BaseTaskConsumer<T extends HeavyTask> {
    ...
    protected void handleMessage(String message, Class<T> taskClass) {
        ...
        try {
            ...
            if (task instanceof com.example.common.infra.heavytask.HeavyTaskByUser) {
                com.example.common.infra.heavytask.HeavyTaskByUser userTask = 
                    (com.example.common.infra.heavytask.HeavyTaskByUser) task;
    ...
    private void processTaskWithSequence(T task, String originalMessage) throws Exception {
        ...
        if (task instanceof com.example.common.infra.heavytask.HeavyTaskByUser) {
            userId = ((com.example.common.infra.heavytask.HeavyTaskByUser) task).getUserId();
        }
